        ...
        <div class="container">
            <div class="row">
                                    ...
                                    <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                <?php
                                                    $msql="SELECT * FROM `subcategory` WHERE `mscat`='$mid'";
                                                    $mrun=mysqli_query($conn,$msql);
                                                    while($mfet=mysqli_fetch_array($mrun)){
                                                        ?>
                                                    <li><a href="./subcategory.php?st=<?php echo $mfet['scid']?>"><?php echo $mfet['subcate']?></a></li>
                                                    <?php
                                                    }
                                                    ?>
                                                </ul>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                    <?php 
                            $psl = "SELECT * FROM `product` WHERE `catedrop` = '$mid'"; 
