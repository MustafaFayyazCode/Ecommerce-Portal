...
<?php
$in=new connection();
$res=$in->select("category","*",null,"`sid`");
?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $data['ccate'] ?></td>
                                            <td><?php echo $data['cdes'] ?></td>
                                            <td><?php echo $data['cdate'] ?></td>
                                            <td><a class="btn btn-primary" href="./updatecategory.php?cuid=<?php echo $fet['sid'] ?>">Update</a></td>
                                           <td><button class="btn btn-danger delete" data-del="<?php echo $fet['sid'] ?>">Delete</button></td>
                                            <?php
                                                }
                                            ?>
                                        </tr>
